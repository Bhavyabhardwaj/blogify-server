...
// Configure CORS
app.use(cors({
    origin: ['http://localhost:8080', 'http://localhost:3000', 'https://blogify-bhavya.up.railway.app', 'https://blogify-client-8n6n69v5d-bhavya-bhardwajs-projects.vercel.app', 'https://blogify-client-o92dcctty-bhavya-bhardwajs-projects.vercel.app'],
